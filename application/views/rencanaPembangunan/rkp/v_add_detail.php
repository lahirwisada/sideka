...
<div class="form-group">
    <label class="col-md-5 control-label" for="tanggal_disusun">Biaya Tersedia<br />(RPJM)</label> 
    <div class="col-md-9">
        <input disabled="disabled" readonly="readonly" type="hidden" name="ref_num_jumlah_biaya" id="inp_ref_num_jumlah_biaya" size="80" value="" aria-describedby="hlpBlock9" /> 
        <input class="form-control input-md required" disabled="disabled" readonly="readonly" type="text" name="ref_jumlah_biaya" id="inp_jumlah_biaya" size="80" value="" aria-describedby="hlpBlock9" /> 
        <span id="hlpBlock9" class="help-block">
