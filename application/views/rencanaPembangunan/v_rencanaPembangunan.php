...
?>
	...
	<div class="col-md-6">
		<div class="table-responsive">
			<table border="0" class="table table-striped table-bordered table-hover">
				...
				<a href="<?php echo site_url('rencanaPembangunan/c_rpjmdes');?>">
	...
	<div class="col-md-6">
		<div class="table-responsive">
			...
			<a href="<?php echo site_url('rencanaPembangunan/c_rkpdes');?>">
					<button type="button" class="btn btn-success btn-xs"><i class="fa fa-newspaper-o fa-fw"></i></button>
				</a>
			</h4>
			<tr class="success">
	...
	<div class="col-md-6">
		<div class="table-responsive">
			...
			<a href="<?php echo site_url('rencanaPembangunan/c_rabdes');?>">
	...
	<div class="col-md-6">
		<div class="table-responsive">
			<table border="0" class="table table-bordered table-hover">
			<h4></b>Data Surat Permintaaan Pembayaran</b>
			<a href="<?php echo site_url('rencanaPembangunan/c_spp');?>">
					<button type="button" class="btn btn-info btn-xs"><i class="fa fa-newspaper-o fa-fw"></i></button>
			</a>
			</h4>
			<tr class="info">
				...
				<td style="text-align:center;">Kegiatan</td>
				<td style="text-align:center;">Total (Rp)</td>
				<td style="text-align:center;">Tanggal Ambil</td>
			</tr>
			<?php
				$i=0;
				foreach($spp as $rows)
